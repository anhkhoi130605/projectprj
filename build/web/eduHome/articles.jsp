...
<head>
    ...
    <title>Bài Viết - EduPlatform</title>
        ...
        <main class="main-content">
            <section class="articles-section">
                <div class="section-header">
                    ...
                    <p style="color: #666; margin-top: 0.5rem;">Khám phá các bài viết hữu ích về lập trình và phát triển web</p>
                </div>
                ...
                <div class="articles-grid">
                    ...
                    <div class="article-card" onclick="navigateTo('articlesDetail.jsp')">
                        <div class="article-image">
                            <img src="${pageContext.request.contextPath}/images/article-thumb1.png" alt="Advanced CSS">
                        </div>
                        <div class="article-info">
                            <h3>CSS Grid - Hướng dẫn toàn diện cho người mới bắt đầu</h3>
                            <div class="article-meta">
                                <span class="author">Sơn Đặng</span>
                                <span class="date">15 phút đọc</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="article-card" onclick="navigateTo('articlesDetail.jsp')">
                        <div class="article-image">
                            <img src="${pageContext.request.contextPath}/images/article-thumb2.png" alt="JavaScript Tips">
                        </div>
                        <div class="article-info">
                            <h3>10 Mẹo JavaScript giúp bạn viết code tốt hơn</h3>
                            <div class="article-meta">
                                <span class="author">Vo Minh Kha</span>
                                <span class="date">8 phút đọc</span>
                            </div>
                        </div>
                    </div>
                </div>
